      ...
      _createClass(WithdrawComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.subscription = this.dashboardService.getAuthData().subscribe(function (res) {
            ...
            _this9.pageTitle = 'Fintech28 | Withdraw';
          });
        }
      }, {
        key: "processRequest",
